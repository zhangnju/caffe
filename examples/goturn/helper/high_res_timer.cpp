...
{
	total_us_.QuadPart = 0;
	QueryPerformanceFrequency(&freq);
	//us
	freq.QuadPart = double(freq.QuadPart) / 1000000.0;
}
...
void HighResTimer::stop()
{
	...
	total_us_.QuadPart += double (end_.QuadPart - start_.QuadPart)/freq.QuadPart;
}
